...
- [x] **Phase 31: Tool Config Form UI** — Config fields for send_sms (Twilio integration picker) and custom_webhook (URL, method, headers, body template) in tool-config-form.tsx (completed 2026-05-08)
